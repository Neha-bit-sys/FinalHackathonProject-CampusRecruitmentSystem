...
<StatusBar style="auto" />
<TouchableOpacity onPress={()=> props.navigation.navigate("Student Data")} activeOpacity= {0.8} style={styles.button}><Text style= {styles.btnText}>Student Data</Text></TouchableOpacity>
<StatusBar style="auto" />
