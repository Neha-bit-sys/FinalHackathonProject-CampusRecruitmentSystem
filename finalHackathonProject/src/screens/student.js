...
<StatusBar style="auto" />
<TouchableOpacity onPress={()=> props.navigation.navigate("Company Data")} activeOpacity= {0.8} style={styles.button}><Text style= {styles.btnText}>Company Data</Text></TouchableOpacity>
<StatusBar style="auto" />
